...
![Version](https://img.shields.io/github/v/release/danielvm-git/bigbase?label=version&color=blue)
![Go](https://img.shields.io/github/go-mod/go-version/danielvm-git/bigbase?logo=go)
