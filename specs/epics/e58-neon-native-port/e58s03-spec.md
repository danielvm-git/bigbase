# e58s03: Better Auth Backend Engine

**Story ID:** e58s03 | **Epic:** e58 — Native Feature Port | **BCPs:** 3 | **Status:** planned
...
- No dependency on e52 (better-auth endpoints are org-level, not project-scoped, for this story).
...
- Project-scoped sessions (deferred to e52 + future story).
