# e58s04: MCP Database Migration Tools

**Story ID:** e58s04 | **Epic:** e58 — Native Feature Port | **BCPs:** 3 | **Status:** planned
...
- **Expose migration HTTP endpoints instead of MCP tools:** useful but separate concern. MCP tools are the e58 scope.
