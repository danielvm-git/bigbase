# e52s02: Projects Table — Backend CRUD

**Story ID:** e52s02 | **Epic:** e52 — Project Scoping Backend | **BCPs:** 3 | **Status:** planned
...
- **Callers of auth:** Proxy (middleware), API (scoping), Sites, Deploy (future: e52s03, e52s04)
...
- **Depends on:** e52s01 (kernel project ID context helpers — used for authorization checks)
- **Depended on by:** e52s03 (DB isolation needs projects table), e52s04 (auth namespacing needs projects)
...
- Project-level API keys (deferred to e59 Secrets)
- Project members/invites (e52s04)
- Project → site/deployment assignment (e52s03, e52s04)
- Project settings/env vars (future)
- Default project auto-creation on org create (e52s04)
