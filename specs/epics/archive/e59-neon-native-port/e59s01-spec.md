# e59s01: SQL-over-HTTP Transport

**Story ID:** e59s01 | **Epic:** e59 — Native Feature Port | **BCPs:** 3 | **Status:** planned
...
- No new Go packages.
- No dependency on e57 (admin endpoint inherits org scoping; project-scoped isolation deferred).
...
- Project-scoped isolation (deferred to e57).
