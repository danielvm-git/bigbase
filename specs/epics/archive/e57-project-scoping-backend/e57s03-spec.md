# e57s03: Database Isolation Per Project

**Story ID:** e57s03 | **Epic:** e57 — Project Scoping Backend | **BCPs:** 3 | **Status:** planned
...
| Auth | User/org management (owns `projects` table) | Proxy middleware, API | No changes — already owns project CRUD from e57s02 |
...
- **Depends on:** e57s01 (kernel project ID helpers), e57s02 (projects table exists)
- **Depended on by:** e57s04 (auth namespacing references project_id in queries)
...
- UI for project-scoped views (e58)
...
5. Register user, create org, verify default project is auto-created (e57s04 will wire this)
